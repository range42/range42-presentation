...
% === OPEN CHALLENGES ===
\begin{frame}[squeeze]{Open Challenges \& Opportunities \; \faExclamationTriangle}
...
\begin{frame}[squeeze]{Get Involved \; \faRocket}
  \begin{columns}[T]
    \column{0.65\textwidth}
    \textbf{Join the Range42 Community}\\[2mm]
    ...
    \begin{figure}
      ...
      \caption*{\footnotesize github.com/range42}
    \end{figure}
  \end{columns}
